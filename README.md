...
This step was created to transform the 64 binary channels into a single channel to be clustered using Spyking Circus <a href="https://github.com/spyking-circus/spyking-circus">Spyking Circus</a>. 
